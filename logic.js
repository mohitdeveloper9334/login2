...
var firstPerson = 'Vishal'; // Replace with the actual name
var firstLocation = 'Samastipur, India'; // Replace with the actual location

var secondPerson = 'Tanya'; // Replace with the actual name
var secondLocation = 'Patna, India';
...
var timeLeaveStamp = new Date(2023, 12, 14);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(2023, 12, 15);
